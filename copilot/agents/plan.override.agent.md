...
tools: [vscode/memory, vscode/runCommand, vscode/vscodeAPI, vscode/askQuestions, execute, read, agent, search, web, 'augment-context-engine/*', vscode.mermaid-chat-features/renderMermaidDiagram, github.vscode-pull-request-github/issue_fetch, github.vscode-pull-request-github/activePullRequest, github/issue_read]
agents: ['Explore']
handoffs:

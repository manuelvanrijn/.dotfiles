...
sudo scutil --set ComputerName "manuel"
sudo scutil --set HostName "manuel"
sudo scutil --set LocalHostName "Manuel"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "manuel"
...
defaults write NSGlobalDomain InitialKeyRepeat -int 15s
